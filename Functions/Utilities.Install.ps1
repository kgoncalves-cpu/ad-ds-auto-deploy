<#
.SYNOPSIS
    Funções para instalar recursos da Active Directory e Domain Services
.DESCRIPTION
    Funções para instalar AD-Domain-Services, obter senha DSRM e promover servidor a Domain Controller
.NOTES
