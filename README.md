...
📁 PsScripts/ <br>
├── 📄 Deploy.ps1 &emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;(Script Principal) <br>
├── 📄 Deploy-AutoContinue.ps1 &emsp;(Automação Pós-Reboot) <br>
├── 📄 Deploy-Part2.ps1&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;(Configuração Pós-Instalação) <br>
├── 📁 Functions/ <br>
│   ├── 📄 Logging.ps1&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;(Sistema de Log) <br>
│   ├── 📄 Validation.ps1&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;(Validadores) <br>
│   ├── 📄 StateManagement.ps1&emsp;&emsp;(Gerenciamento de Estado) <br>
│   └── 📄 Utilities.ps1&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;(Funções Auxiliares) <br>
├── 📁 Config/ <br>
│   ├── 📄 Default.psd1&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;(Configuração Padrão) <br>
│   ├── 📄 Test.psd1&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;(Ambiente de Teste) <br>
│   └── 📄 Production.psd1&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;(Ambiente Produção) <br>
└── 📁 Logs/ <br>
    └── 📄 ADDeployment_*.log&emsp;&emsp;&emsp;&emsp;(Arquivos de Log) <br>
